...
Since Zen Browser is still under development and [under the usage threshold](https://www.1password.community/discussions/1password/support-for-zen-browser/115811/replies/151343) 1Password takes in consideration Zen Browser is not within this list causing the 1Password Browser integration to fail.
